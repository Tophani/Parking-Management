        ...
        config = {
            ...
            data: {
                ...
                }, 
                {
                    ...
                    data: [
                        {{ !empty($amount->jan)?number_format($amount->jan, 1):0 }}, 
                        {{ !empty($amount->feb)?number_format($amount->feb, 1):0 }}, 
                        {{ !empty($amount->mar)?number_format($amount->mar, 1):0 }}, 
                        {{ !empty($amount->apr)?number_format($amount->apr, 1):0 }}, 
                        {{ !empty($amount->may)?number_format($amount->may, 1):0 }}, 
                        {{ !empty($amount->jun)?number_format($amount->jun, 1):0 }}, 
                        {{ !empty($amount->jul)?number_format($amount->jul, 1):0 }}, 
                        {{ !empty($amount->aug)?number_format($amount->aug, 1):0 }}, 
                        {{ !empty($amount->sep)?number_format($amount->sep, 1):0 }}, 
                        {{ !empty($amount->oct)?number_format($amount->oct, 1):0 }}, 
                        {{ !empty($amount->nov)?number_format($amount->nov, 1):0 }}, 
                        {{ !empty($amount->decx)?number_format($amount->decx, 1):0 }} 
                    ],
